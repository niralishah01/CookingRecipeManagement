...
using WebClient.RecipeServiceReference;
...
namespace WebClient
{
    public partial class Home : System.Web.UI.Page
    {
        ...
        private void addDislike(object sender, EventArgs e, string s)
        {
        ...
        private void addLike(object sender, EventArgs e, string ID)
        {
            RecipeServiceReference.RecipeServiceClient proxy = new RecipeServiceReference.RecipeServiceClient();
        ...
        protected void add_ServerClick(object sender, EventArgs e)
        {
            ...
            url += "userid=" + Server.UrlEncode(Request.QueryString["userid"]) + "&";
            url += "name=" + Server.UrlEncode(Request.QueryString["uname"]);
            Response.Redirect(url);
        }
    }
}