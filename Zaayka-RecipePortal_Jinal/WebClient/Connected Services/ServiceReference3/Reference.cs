...
namespace WebClient.ServiceReference3 {
    ...
    public interface ICommentService {
        ...
        string AddComment(WebClient.ServiceReference3.Comments comment);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICommentService/AddComment", ReplyAction="http://tempuri.org/ICommentService/AddCommentResponse")]
        System.Threading.Tasks.Task<string> AddCommentAsync(WebClient.ServiceReference3.Comments comment);
        ...
        WebClient.ServiceReference3.Comments[] ViewComments(int recipeId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICommentService/ViewComments", ReplyAction="http://tempuri.org/ICommentService/ViewCommentsResponse")]
        System.Threading.Tasks.Task<WebClient.ServiceReference3.Comments[]> ViewCommentsAsync(int recipeId);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ICommentServiceChannel : WebClient.ServiceReference3.ICommentService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class CommentServiceClient : System.ServiceModel.ClientBase<WebClient.ServiceReference3.ICommentService>, WebClient.ServiceReference3.ICommentService {
        ...
        public string AddComment(WebClient.ServiceReference3.Comments comment) {
            return base.Channel.AddComment(comment);
        }
        
        public System.Threading.Tasks.Task<string> AddCommentAsync(WebClient.ServiceReference3.Comments comment) {
            return base.Channel.AddCommentAsync(comment);
        }
        
        public WebClient.ServiceReference3.Comments[] ViewComments(int recipeId) {
            return base.Channel.ViewComments(recipeId);
        }
        
        public System.Threading.Tasks.Task<WebClient.ServiceReference3.Comments[]> ViewCommentsAsync(int recipeId) {
