    ...
    public partial class MyRecipes : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Request.QueryString["userid"] != null)
            {
                ...
                AccountServiceClient account_proxy = new AccountServiceClient("BasicHttpBinding_IAccountService");
                ...
                Recipe[] recipeList = proxy.GetUserSpecificRecipes(Convert.ToInt32(Request.QueryString["userid"]));
                int r = 0, c = 0;
