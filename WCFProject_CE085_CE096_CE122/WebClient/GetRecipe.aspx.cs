...
using WebClient.ServiceReference3;
    ...
    public partial class GetRecipe : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["userid"] != null)
            {
                ...
                try
                {
                    Recipe recipe = client.GetRecipe(Convert.ToInt32(Request.QueryString["rid"]));
                    card_h.InnerText = recipe.Title;

                    AccountServiceClient account_proxy = new AccountServiceClient();
                    Users current_user = account_proxy.GetUserDetail(Convert.ToInt32(recipe.UserID));
