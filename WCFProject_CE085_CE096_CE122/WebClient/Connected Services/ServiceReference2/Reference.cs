...
namespace WebClient.ServiceReference2 {
    ...
    public interface IAccountService {
        ...
        string Register(WebClient.ServiceReference2.Users u);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAccountService/Register", ReplyAction="http://tempuri.org/IAccountService/RegisterResponse")]
        System.Threading.Tasks.Task<string> RegisterAsync(WebClient.ServiceReference2.Users u);
        ...
        WebClient.ServiceReference2.Users Login(string email, string password);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAccountService/Login", ReplyAction="http://tempuri.org/IAccountService/LoginResponse")]
        System.Threading.Tasks.Task<WebClient.ServiceReference2.Users> LoginAsync(string email, string password);
        ...
        void UpdateUserDetails(WebClient.ServiceReference2.Users u);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAccountService/UpdateUserDetails", ReplyAction="http://tempuri.org/IAccountService/UpdateUserDetailsResponse")]
        System.Threading.Tasks.Task UpdateUserDetailsAsync(WebClient.ServiceReference2.Users u);
        ...
        WebClient.ServiceReference2.Users GetUserDetail(int ID);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAccountService/GetUserDetail", ReplyAction="http://tempuri.org/IAccountService/GetUserDetailResponse")]
        System.Threading.Tasks.Task<WebClient.ServiceReference2.Users> GetUserDetailAsync(int ID);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAccountServiceChannel : WebClient.ServiceReference2.IAccountService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AccountServiceClient : System.ServiceModel.ClientBase<WebClient.ServiceReference2.IAccountService>, WebClient.ServiceReference2.IAccountService {
        ...
        public string Register(WebClient.ServiceReference2.Users u) {
            return base.Channel.Register(u);
        }
        
        public System.Threading.Tasks.Task<string> RegisterAsync(WebClient.ServiceReference2.Users u) {
            return base.Channel.RegisterAsync(u);
        }
        
        public WebClient.ServiceReference2.Users Login(string email, string password) {
            return base.Channel.Login(email, password);
        }
        
        public System.Threading.Tasks.Task<WebClient.ServiceReference2.Users> LoginAsync(string email, string password) {
            return base.Channel.LoginAsync(email, password);
        }
        
        public void UpdateUserDetails(WebClient.ServiceReference2.Users u) {
            base.Channel.UpdateUserDetails(u);
        }
        
        public System.Threading.Tasks.Task UpdateUserDetailsAsync(WebClient.ServiceReference2.Users u) {
            return base.Channel.UpdateUserDetailsAsync(u);
        }
        
        public WebClient.ServiceReference2.Users GetUserDetail(int ID) {
            return base.Channel.GetUserDetail(ID);
        }
        
        public System.Threading.Tasks.Task<WebClient.ServiceReference2.Users> GetUserDetailAsync(int ID) {
