<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateRecipe.aspx.cs" Inherits="WebClient.UpdateRecipe" %>
    ...
    <form id="form1" runat="server">
        <div class="container w-75 mt-3">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Enter recipe name" id="title" runat="server" required=""/>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                <label for="FileUpload1" class="col-sm-2 col-form-label">New Photo:</label>
                <div class="col-sm-10">
